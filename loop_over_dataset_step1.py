...
configs_det = det.load_configs(model_name='fpn_resnet') # options are 'darknet', 'fpn_resnet'  # ID_S3_EX1
# configs_det = det.load_configs(model_name='darknet') # options are 'darknet', 'fpn_resnet' # ID_S1_.., ID_S2_..
...
# added min_iou because of ID_S4_EX1 misses this config
# configs.min_iou = 0.8
...
while True:
    try:
        ...
        if 'bev_from_pcl' in exec_list:
            ...
            lidar_bev = pcl.bev_from_pcl(lidar_pcl, configs_det, False)
        else:
        ...
        if 'measure_detection_performance' in exec_list:
            ...
            if 'perform_tracking' in exec_list:
                ...
                # file not exists so use other one
        ...
        if 'show_range_image' in exec_list:
            img_range = pcl.show_range_image(frame, lidar_name) #, crop_90=True)
